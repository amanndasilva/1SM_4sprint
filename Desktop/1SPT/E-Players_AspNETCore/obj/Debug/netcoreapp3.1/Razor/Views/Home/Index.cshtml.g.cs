#pragma checksum "C:\Users\senai\Desktop\SenaiPOO\E-Players_AspNETCore\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d2c6cb64b11fd5abc42465081845c9b1a7000890"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d2c6cb64b11fd5abc42465081845c9b1a7000890", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\senai\Desktop\SenaiPOO\E-Players_AspNETCore\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("\r\n<div class=\"banner\">\r\n    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d2c6cb64b11fd5abc42465081845c9b1a70008904261", async() => {
...
<div class=""container co");
    ...
    <section class=""noticias"">
        ...
        <div class=""card"">
            <img src=""Images/Teams/T1.jpeg"" alt=""Notícia a equipe 1"">
            <div>
        ...
        <div class=""card"">
            <img src=""Images/Teams/T2.jpg"" alt=""Notícia a equipe 2"">
            <div>
                <h4>Título da Noticia</h4>
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos quibusdam quidem praesentium
                    velit vel sapiente nemo obcaecati veritatis dolorum odio facere, quisquam mollitia quo eum.
    ...
    ");
        ...
        <div class=""card"">
            <img src=""Images/Teams/T3.jpeg"" alt=""Notícia sobre a equipe 3"">
            <div>
                <h4>Título da Noticia</h4>
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos quibusdam quidem praesentium
                    velit vel sapiente nemo obcaecati veritatis dolorum odio facere, quisquam mollitia quo eum.
        ...
        <div class=""card"">
            <img src=""Images/Teams/T9.jpeg"" alt=""Notícia sobre a equipe 9"">
            <div>
                <h4>Título da Noticia</h4>
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos quibusdam quidem praesentium
                    velit vel sapiente nemo obcaecati veritatis dolorum odio facere, quisquam mollitia quo eum.
                    Aspernatur quam reiciendis ratione ");
            WriteLiteral(@"dolorem!
                </p>
            </div>
        </div>

        <div class=""card"">
            <img src=""Images/Teams/T5.jpeg"" alt=""Notícia sobre a equipe 5"">
            <div>
                <h4>Título da Noticia</h4>
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos quibusdam quidem praesentium
                    velit vel sapiente nemo obcaecati veritatis dolorum odio facere, quisquam mollitia quo eum.
        ...
        <div class=""card"">
            <img src=""Images/Teams/T7.jpeg"" alt=""Notícia sobre a equipe 7"">
            <div>
                <h4>Título da Noticia</h4>
                <p> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quos quibusdam quidem praesentium
                    velit vel sapiente nemo obcaecati veritatis dolorum odio facere, quisquam mollitia quo eum.
                    Aspernatur quam reici");
            WriteLiteral(@"endis ratione dolorem!
                </p>
            </div>
        </div>
    ...
    <section class=""recentes"" id=""resultados"">
        ...
        <div class=""resultado"">
            <div class=""team"">
                <strong>SK</strong>
                <img s");
            WriteLiteral(@"rc=""Images/SK.png"" alt=""Logo da equipe SK"">
                <I>VS</I>
                <img src=""Images/FLA.png"" alt=""Logo da equipe do Flamengo"">
                <strong>FLA</strong>
            </div>
